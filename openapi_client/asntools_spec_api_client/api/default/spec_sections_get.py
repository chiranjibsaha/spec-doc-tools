...
from ...models.spec_sections_get_response_spec_sections_get import SpecSectionsGetResponseSpecSectionsGet
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/specs/{spec_id}/sections/{section_id}".format(
...
) -> HTTPValidationError | SpecSectionsGetResponseSpecSectionsGet | None:
    if response.status_code == 200:
        response_200 = SpecSectionsGetResponseSpecSectionsGet.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | SpecSectionsGetResponseSpecSectionsGet]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | SpecSectionsGetResponseSpecSectionsGet
    """
